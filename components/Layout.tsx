...
export const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  return (
    <div className="h-screen overflow-hidden bg-brand-dark flex flex-col font-sans text-brand-text">
      {/* Top Header */}
      ...
      {/* Main Content Area */}
      <main className="flex-1 relative overflow-hidden pb-24 h-full">
        {children}
      </main>
